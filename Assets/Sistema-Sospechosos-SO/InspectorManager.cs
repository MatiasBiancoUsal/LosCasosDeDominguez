...
public class InspectionManager : MonoBehaviour
{
    ...
    // Evita que la misma Q que abre el panel lo cierre instant�neamente
    ...
    private void Update()
    {
        ...
        if (Keyboard.current.qKey.wasPressedThisFrame)
        {
            ...
            Debug.Log("Panel de inspecci�n cerrado.");
        }
    }
    ...
    public void InspectZone(InspectionZone zone)
    {
        ...
        if (clue == null)
        {
            Debug.Log("No se encontr� ninguna pista.");
            return;
        }
    ...
    public void SetSuspect(SuspectData suspect)
    {
        if (suspect == null)
        {
            Debug.LogWarning("SetSuspect recibi� un sospechoso nulo.");
            return;
        }
